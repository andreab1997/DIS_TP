...
def a_Qg_3_incomplete(n, sx, nf):
    """Known parts of a_Qg_3 (including the part proportional to nf)"""
    S1, _ = sx[0]
    S2, Sm2 = sx[1]
...
def Mbg_3_l0_N_incomplete(n, nf):
    """Mbg_3_l0 without the term A_Qg_30"""
    ...
    tmp = (
        nf
        * (a_Qg_3_incomplete(n, sx, nf + 1) - a_Qg_3_incomplete(n, sx, nf))  # = a_Qg_31
